...
\hypersetup{
 ...
 pdflang={English}}
\usepackage{biblatex}
\addbibresource{/home/sup/ME-310-1TH/me310.bib}
\begin{document}
...
\section{Definition of Safety Factor}
...
\section{Selection of Safety Factors}
...
\section{Recommended Values for Safety Factors}
...
\section{Safety factor for a training bicycle for toddlers}
\label{sec:org189fd1f}
...
\section{Iron-Based Superalloys}
...
\section{Nickel Alloys and Nickel-Based Superalloys}
...
\section{Material Selection Factors}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{pictures/Material-selection/strength-density-diagram.pdf}
\caption{\label{fig: strength density diagram}Material strength, \(S\), versus density, \(\rho\), chart. \cite{ashby2010materials}}
\end{figure}
...
\section{Equilibrium Requirement}
...
\section{Hooke's Law in One Dimension}
...
\section{Shear stress-shear strain relationship}
...
\section{Longitudinal strains in beams}
...
\section{Normal stresses in beams}
...
\section{Moment-curvature formula}
...
\section{Elastic Flexure Formula}
...
\section{Maximum stress at a cross section}
...
\section{2D Stress Transformation}
...
\section{Principal stresses in 2D}
...
\section{Maximum Shear Stresses in 2D}
...
\section{Maximum shear stress theory (Tresca criteria)}
...
\section{Maximum distortion energy theory (Von Mises criteria)}
...
\section{Ductile Coulomb-Mohr theory}
...
\section{Modified Coulomb-Mohr theory}
...
\section{Fatigue under zero mean stress}
...
\section{Fatigue under nonzero mean stress}
...
\section{Ideal column with pin supports}
...
\section{Design of simple columns}
...
\section{Design of columns for concentric loading}
...
\section{Design of columns for eccentric loading}
...
\section{Torsion Bar Spring Stress and Deformation}
...
\section{Torsion Bar Spring Materials}
...
\caption{\label{fig: helical spring geometry}Helical spring geometry and loading conditions.}
\end{figure}
...
\section{Helical Spring Constant and Deflection}
...
\section{Analysis for Helical Compression Springs under Static Loading}
...
\section{End Designs of Helical Compression Springs}
...
\section{Buckling Analysis of Helical Compression Springs}
...
\section{Design Procedure for Helical Compression Spring---Static Loading}
...
\ref{fig: spring design flowchart}
...
\section{Design of Helical Compression Springs for Fatigue Loading}
...
\section{Frequency Consideration}
...
There are two general types of torsion springs: helical and spiral (\ref{fig: spiral and helical springs}).
...
where \(K_i\) is given in \ref{fig: torsion spring stress conc} for various cross sections used in spring application.
...
\section{Combined Torsion and Axial Load}
...
\section{Thread Bearing (Compressive) Stress}
...
\section{Thread Shear (Stripping) Stress and Nut Thickness Requirement}
...
\section{Clamped Parts Stiffness}
...
\section{Bolt sizing for a flange joint under fatigue loading}
\label{sec:org02c6e3f}
...
\section{Direct Equilibrium Method}
...
\section{Solidworks Simulation Module Basics}
