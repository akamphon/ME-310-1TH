...
\hyperref[fig: engineering design processes]{\begin{figure}[htbp]

\includegraphics[width=.9\linewidth]{pictures/intro-eng-design/eng-design-process.pdf}
\caption{\label{fig: engineering design processes}Flowchart of typical engineering design processes}
\end{figure}}
